...
passport._define('fillUserName_tangram.js'/*tpa=http://passport.baidu.com/passApi/js/fillUserName_tangram.js*/, function(){
    importScript("tangram-min.js"/*tpa=http://passport.baidu.com/passApi/js/lib/tangram-min.js*/);
    ...
    importScript("fillusername.js"/*tpa=http://passport.baidu.com/passApi/js/lang/fillusername.js*/);
    ...
    importScript("fillUserName-1.js"/*tpa=http://passport.baidu.com/passApi/js/modules/fillUserName.js*/);
    return magic;
})
