...
passport._define('checkIDcard_tangram.js'/*tpa=http://passport.baidu.com/passApi/js/checkIDcard_tangram.js*/, function(){
    ...
    importScript("checkIDcard-1.js"/*tpa=http://passport.baidu.com/passApi/js/lang/checkIDcard.js*/);
    ...
    importScript("checkIDcard-2.js"/*tpa=http://passport.baidu.com/passApi/js/modules/checkIDcard.js*/);
    return magic;
})
