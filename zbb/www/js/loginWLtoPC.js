...
passport._define('loginWLtoPC.js'/*tpa=http://passport.baidu.com/passApi/js/loginWLtoPC.js*/, function(){
    ...
    importScript("loginWLtoPC-1.js"/*tpa=http://passport.baidu.com/passApi/js/modules/loginWLtoPC.js*/);
    return magic;
})
